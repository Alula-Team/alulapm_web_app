...
import { onSnapshot, Timestamp, collection, orderBy, query } from 'firebase/firestore'
...
const OneProperty = ({ thing }) => {
    ...
    // if (thing) {
    //     if (!thing.createdAt && thing.metadata.hasPendingWrites) {
    //         zeeDate = Timestamp.now().toDate().toLocaleDateString("en-us", {
    //             year: "numeric",
    //             month: "short",
    //             day: "numeric",
    //         })
    //         console.log(`timestamp for now: ${zeeDate} (estimated)`)
    //     }
    //     else {
    //         zeeDate = thing.createdAt.toDate().toLocaleDateString("en-us", {
    //             year: "numeric",
    ...
    //             day: "numeric",
    //         })
    //         console.log(`timestamp: ${thing.createdAt} (actual ass time)`)
    //     }
    // }


    // let zeeDate = thing.createdAt.toDate().toLocaleDateString("en-us", {
    //     year: "numeric",
    //     month: "short",
    //     day: "numeric",
    // })
...
const PropertiesTable = () => {
    ...
    // const ref = doc(db, "properties", "special")
    // onSnapshot(ref, snap => {
    //     const data = snap.data()
    //     if (data) {
    //         if (!data.createdAt && snap.metadata.hasPendingWrites) {
    //             const ts = Timestamp.now()
    //             console.log(`timestamp for now: ${ts} (estimated)`)
    //         }
    //         else {
    //             console.log(`timestamp: ${data.createdAt} (actual ass time)`)
    //         }
    //     }
    // })
    ...
    useEffect(() => {
        ...
        unsubscribe = onSnapshot(q, querySnapshot => {
            ...
            querySnapshot.forEach(doc => {
                if (!doc.data().createdAt && doc.metadata.hasPendingWrites) {
                    time = Timestamp.now()
                }
                else {
                    time = doc.data().createdAt
                }
                properties.push({ id: doc.id, createdAt: time, ...doc.data() })
            })
